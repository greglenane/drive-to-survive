...
if gp_api.at[0, 'MRData_RaceTable_Races']:
    rnd = gp_api.at[0, 'MRData_RaceTable_Races'][0]['round']
    year = gp_api.at[0, 'MRData_RaceTable_Races'][0]['season']
    print(f"Processing data for Year: {year}, Round: {rnd}")
    ...
    if sprint_api.at[0, 'MRData_RaceTable_Races']:
        ...
        print(f"No sprint data available for this round {rnd}.")
else:
    print("No GP data available yet.")
